...
SELECT 
    ...
    CAST(FORMAT_TIMESTAMP('%Y%m%d', TIMESTAMP(ivr_calls.start_date)) AS INT64) AS calls_start_date_id,
	ivr_calls.end_date AS calls_end_date,
	CAST(FORMAT_TIMESTAMP('%Y%m%d', TIMESTAMP(ivr_calls.end_date)) AS INT64) AS calls_end_date_id,
